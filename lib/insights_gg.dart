      ...
      return [
        {
          "${l.indexOf(e) + 1}": l2
              .where((element) =>
                  (attendance
                      .where((element3) => element3['user_id'] == element)
                      .map((e) => e['session_id'])
                      .toList()
                      .length) ==
                  (l.indexOf(e) + 1))
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => int.parse(element['age']) >= 13 && int.parse(element['age']) <= 19).length}',
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => int.parse(element['age']) >= 20 && int.parse(element['age']) <= 25).length}',
                                style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13.5,
                                    color: Color(0xff440077)),
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => int.parse(element['age']) >= 26 && int.parse(element['age']) <= 30).length}',
                                style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13.5,
                                    color: Color(0xff440077)),
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => int.parse(element['age']) >= 31 && int.parse(element['age']) <= 35).length}',
                                style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13.5,
                                    color: Color(0xff440077)),
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => int.parse(element['age']) >= 36 && int.parse(element['age']) <= 40).length}',
                                style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13.5,
                                    color: Color(0xff440077)),
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => element['gender'] == 'M').length}',
                                style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13.5,
                                    color: Color(0xff440077)),
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: Text(
                                '${userdetails.where((element) => element['gender'] == 'F').length}',
                                style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13.5,
                                    color: Color(0xff440077)),
